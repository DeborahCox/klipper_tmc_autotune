...
```bash
wget -O - https://raw.githubusercontent.com/DeborahCox/klipper_tmc_autotune/main/install.sh | bash
```
...
origin: https://github.com/DeborahCox/klipper_tmc_autotune.git
